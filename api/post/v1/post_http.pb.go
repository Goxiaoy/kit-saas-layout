...
func RegisterPostServiceHTTPServer(s *http.Server, srv PostServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/github.com/goxiaoy/kit-saas-layout/post/list", _PostService_ListPost0_HTTP_Handler(srv))
	r.GET("/v1/github.com/goxiaoy/kit-saas-layout/posts", _PostService_ListPost1_HTTP_Handler(srv))
	r.GET("/v1/github.com/goxiaoy/kit-saas-layout/post/{id}", _PostService_GetPost0_HTTP_Handler(srv))
	r.POST("/v1/github.com/goxiaoy/kit-saas-layout/post", _PostService_CreatePost0_HTTP_Handler(srv))
	r.PATCH("/v1/github.com/goxiaoy/kit-saas-layout/post/{post.id}", _PostService_UpdatePost0_HTTP_Handler(srv))
	r.PUT("/v1/github.com/goxiaoy/kit-saas-layout/post/{post.id}", _PostService_UpdatePost1_HTTP_Handler(srv))
	r.DELETE("/v1/github.com/goxiaoy/kit-saas-layout/post/{id}", _PostService_DeletePost0_HTTP_Handler(srv))
}
...
func (c *PostServiceHTTPClientImpl) CreatePost(ctx context.Context, in *CreatePostRequest, opts ...http.CallOption) (*Post, error) {
	var out Post
	pattern := "/v1/github.com/goxiaoy/kit-saas-layout/post"
...
func (c *PostServiceHTTPClientImpl) DeletePost(ctx context.Context, in *DeletePostRequest, opts ...http.CallOption) (*DeletePostReply, error) {
	...
	pattern := "/v1/github.com/goxiaoy/kit-saas-layout/post/{id}"
...
func (c *PostServiceHTTPClientImpl) ListPost(ctx context.Context, in *ListPostRequest, opts ...http.CallOption) (*ListPostReply, error) {
	...
	pattern := "/v1/github.com/goxiaoy/kit-saas-layout/posts"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *PostServiceHTTPClientImpl) UpdatePost(ctx context.Context, in *UpdatePostRequest, opts ...http.CallOption) (*Post, error) {
	var out Post
	pattern := "/v1/github.com/goxiaoy/kit-saas-layout/post/{post.id}"
	path := binding.EncodeURL(pattern, in, false)
